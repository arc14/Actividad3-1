...
public class Geometria {
	...
	public static void main(String[] args) {
		...
		/**
		 * Se llama a la clase cuadrado dando el valor 10 y con get obtenemos el valor
		 * area.
		 * 
		 * @param calcula area cuadrado
		 */
		...
		/**
		 * Se llama a la clase circulo dando el valor 200 y con get obtenemos el valor
		 * area.
		 * 
		 * @param calcula area circulo
		 */
		Circulo circulo = new Circulo(200);
		circulo.area();
		System.out.println("Area del circulo de radio 200: " + circulo.getAreaRadio());
		/**
		 * Se llama a la clase rectangulo dandole dos valores, 100 y 20, y con get
		 * obtenemos el valor area.
		 * 
		 * @param calcula area rectangulo
		 */
		Rectangulo rectangulo = new Rectangulo(100, 20);
		rectangulo.area();
		System.out.println("Area del rectangulo de base 100 y altura 20: " + rectangulo.getAreaRectangulo());
		/**
		 * Se llama a la clase triangulo ddandole dos valores, 5 y 10, y con get obtenemos el valor area.
		 * @param calcula area triangulo
		 */
		Triangulo triangulo = new Triangulo(5, 10);
		triangulo.area();
		System.out.println("Area del triangulo de base 5 y altura 10: " + triangulo.getareaTriangulo());
	}
